      ...
      <section>
        <div className={cn(glassSurfaceClassName, 'overflow-hidden')}>
          <div
            ...
            className="relative z-10 flex items-center justify-between gap-3 border-b border-border/50 bg-muted/60 px-4 py-3 shadow-[inset_0_1px_0_0_color-mix(in_oklch,var(--foreground)_8%,transparent)]"
          >
